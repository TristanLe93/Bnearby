...
- (void)setupView {
    ...
    _star = [UIImage imageNamed:@"Cost_Filter_Unused.png"];
    //	_highlightedStar = [UIImage imageNamed:@"star_highlighted.png"];
    _highlightedStar = [UIImage imageNamed:@"Cost_Filter_Used.png"];
...
- (void)layoutSubviews {
	...
	// Align the starts in the center of the view
...
- (BOOL)beginTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event {
	...
	if (index != NSNotFound) {
		...
		if ([self.delegate respondsToSelector:@selector(starRatingControl:willUpdateRating:)]) {
			[self.delegate costRatingControl:self willUpdateRating:self.rating];
		}
...
- (void)endTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event {
	if ([self.delegate respondsToSelector:@selector(starRatingControl:didUpdateRating:)]) {
		[self.delegate costRatingControl:self didUpdateRating:self.rating];
	}
